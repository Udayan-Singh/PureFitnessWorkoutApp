...
const Generator = (props) => {
    ...
    const {poison,goal,muscles,setMuscles,setPoison,setGoal,updateWorkout} = props
    ...
    function updateMuscles(muscleGroup) {
        ...
        if(muscles.length > 2){
            return // remember to not train too many muscles guys, 2 per day is more than enough
        }
  ...
  return (
    <SectionWrapper id={'generate'} header={"generate your workout"} title={['It\'s', 'Huge', '0\'clock']}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            return(
                <button onClick={() => {
                    setMuscles([])
                    setPoison(type)
                }} className={"bg-slate-950 border border-blue-400 duration-200 hover:border-blue-600 py-3 rounded-lg px-4" + (type === poison? 'border-blue-600': 'border-blue-400')} 
                 key={typeIndex}>
        ...
        <div className="bg-slte-950 border border-solid
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            return(
                <button onClick={() => {
                    setGoal(scheme)
                }} className={"bg-slate-950 border border-blue-400 px-4 duration-200 hover:border-blue-600 py-3 rounded-lg" + (scheme === goal? 'border-blue-600': 'border-blue-400')} 
                 key={schemeIndex}>
